...
function initMcpServer(queue, tools, sessions, proc) {
    const server = new Server({ name: 'roblox-mcp-difz', version: '1.0.0' }, { capabilities: { tools: {}, resources: {}, prompts: {} } });
...
function runServerTool(name, args, proc, sessions) {
    switch (name) {
