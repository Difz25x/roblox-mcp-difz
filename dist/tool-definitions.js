    ...
    _defineTools() {
        return [
            ...
            },
            {
                ...
                description: "Enumerate every Instance currently parented to nil (the data model root but outside game). Anti-cheat frameworks and core scripts are often hidden here to prevent tampering. Returns name, class, full path (before being nilled), and optional script source.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "include_source": {
            ...
            },
            {
                ...
                description: "Hide, destroy, or restore executor GUI elements from CoreGui and PlayerGui. Many anti-cheat systems take periodic screenshots or enumerate CoreGui children to detect exploit GUIs. This tool removes those traces.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "action": {
            ...
            },
            {
                ...
                description: "Types a string of text character-by-character with configurable per-character delay, simulating human keyboard input. Supports multi-line strings and special character handling. Can optionally press Enter after the text and randomize the typing speed profile for anti-detection purposes.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "text": {
            ...
            },
            {
                ...
                inputSchema: {
                    ...
                    "properties": {
                        ...
                        "roblox_locked": {
                            "type": "boolean",
                            "description": "Workspace.RobloxLocked. When true, prevents all non-local physics interactions (parts cannot be pushed/destroyed by the server). Bypasses many physics-based anti-tamper checks.",
                            "default": false
                        },
            ...
            },
            {
                ...
                description: "Manage Teams and Team colors through the Teams service. Can create, rename, recolor, and remove teams, reassign players between teams, set TeamColor on instances, and control the AutoAssignTeams behavior. Also supports modifying the Players.TeamColor property and team-based spawn assignment. Enables full control of the game's team system for testing or bypass purposes.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "action": {
            ...
            },
            {
                ...
                inputSchema: {
                    ...
                    "properties": {
                        ...
                        "identity_spoof": {
                            "type": "integer",
                            "description": "Identity level to use when performing the modification. Higher values bypass sandbox restrictions on metatable access.",
                            "minimum": 0,
                            "maximum": 10,
                            "default": 8
                        }
            ...
            },
            {
                ...
                inputSchema: {
                    ...
                    "properties": {
                        ...
                        "include_protected": {
                            "type": "boolean",
                            "description": "When true, attempts to include registry entries that are typically hidden or marked as read-only. May trigger anti-tamper heuristics. Default is false.",
                            "default": false
                        }
                    },
                    "required": []
            ...
            },
            {
                ...
                inputSchema: {
                    ...
                    "properties": {
                        ...
                        "test_depth": {
                            "type": "string",
                            "description": "How thoroughly to probe the sandbox. 'quick' tests a standard set of 30 indicators. 'standard' runs comprehensive checks including metatable inspection and function hook detection. 'paranoid' also attempts known bypass techniques to map the full attack surface. Default is 'standard'.",
                            "enum": [
                                "quick",
                                "standard",
                                "paranoid"
                        ...
                        "detect_hooks": {
                            "type": "boolean",
                            "description": "When true, compares checksums of in-memory core library functions against their expected bytecode to detect existing function hooks (installed by anti-exploit systems or other exploit tools). Default is true.",
                            "default": true
                        },
                        "identity_probe": {
                            "type": "boolean",
            ...
            },
            {
                ...
                description: "Scan every service (ReplicatedStorage, Workspace, ServerScriptService, etc.) for RemoteEvent and RemoteFunction instances. Returns their full paths, class names, and optional parent hierarchy. Used to map the full remote attack surface.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "search_paths": {
            ...
            },
            {
                ...
                description: "Analyze network ownership of BasePart instances in Workspace. Returns which parts the client owns (can physics-lag exploit), which are server-owned, and which are unowned. Useful for physics-based exploit identification.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "filter_by_name": {
            ...
            },
            {
                ...
                description: "Trigger every ProximityPrompt within range instantly, bypassing HoldDuration and Cooldown. Useful for auto-farming interactions (pickups, doors, NPCs) or testing prompt-based mechanics.",
                inputSchema: {
                    "type": "object",
                    "properties": {
                        "range": {
